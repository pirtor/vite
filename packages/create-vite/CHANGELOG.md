...
* release: create-vite@5.2.1 ([b23ead0](https://github.com/pirtor/vite/commit/b23ead0))
* release: create-vite@5.2.2 ([e8c1716](https://github.com/pirtor/vite/commit/e8c1716))
* release: create-vite@5.2.3 ([10a10fd](https://github.com/pirtor/vite/commit/10a10fd))
...
* fix(deps): update all non-major dependencies (#16258) ([7caef42](https://github.com/pirtor/vite/commit/7caef42)), closes [#16258](https://github.com/pirtor/vite/issues/16258)
* docs: update readme ([b61e3d7](https://github.com/pirtor/vite/commit/b61e3d7))
* docs(create-vite): link to Vue docs for IDE support info (#16225) ([520bb89](https://github.com/pirtor/vite/commit/520bb89)), closes [#16225](https://github.com/pirtor/vite/issues/16225)
* chore: update npm package info ([a52aff2](https://github.com/pirtor/vite/commit/a52aff2))
* chore: update vscode config in templates ([dd74977](https://github.com/pirtor/vite/commit/dd74977))
...
## <small>5.2.2 (2024-02-26)</small>

* chore: update vscode config in templates ([dd74977](https://github.com/pirtor/vite/commit/dd74977))
* chore(deps): update typescript-eslint monorepo to v7 (major) (#15960) ([7b9e927](https://github.com/pirtor/vite/commit/7b9e927)), closes [#15960](https://github.com/pirtor/vite/issues/15960)
* docs: update readme ([b61e3d7](https://github.com/pirtor/vite/commit/b61e3d7))
* release: create-vite@5.2.1 ([edb9c4c](https://github.com/pirtor/vite/commit/edb9c4c))
* fix(create-vite): remove tsc command from qwik template (#15982) ([5e05f10](https://github.com/pirtor/vite/commit/5e05f10)), closes [#15982](https://github.com/pirtor/vite/issues/15982)
* fix(deps): update all non-major dependencies (#15959) ([571a3fd](https://github.com/pirtor/vite/commit/571a3fd)), closes [#15959](https://github.com/pirtor/vite/issues/15959)
* fix(qwik template): change preview script (#15975) ([725589a](https://github.com/pirtor/vite/commit/725589a)), closes [#15975](https://github.com/pirtor/vite/issues/15975)
* feat(create-vite): add custom remix option for React (#15995) ([f3b195c](https://github.com/pirtor/vite/commit/f3b195c)), closes [#15995](https://github.com/pirtor/vite/issues/15995)
